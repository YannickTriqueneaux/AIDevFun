...
public:
  static constexpr Engine::Gameplay::TypeID Type =
      Engine::Gameplay::StableTypeID("BaseGame.PlayerComponent");
  ...
  [[nodiscard]] Engine::Gameplay::TypeID GetTypeID() const override {
    return Type;
  }
  [[nodiscard]] std::uint32_t CurrentStateVersion() const override {
    return CurrentVersion;
  }
  [[nodiscard]] std::uint32_t MinimumStateVersion() const override {
    return MinimumVersion;
  }
  void SetCommand(PlayerCommand command) { command_ = command; }
  void Update(Engine::Gameplay::ObjectManager &objects,
  ...
  void LoadState(Engine::Gameplay::StateReader &reader,
