...
Json Tools() {
  ...
  return Json::array(
      {Tool("game_tools_status",
       ...
       Tool("get_git_status",
            "Check commit/push readiness and get the repository web URL."),
       Tool("read_git_changes",
            "Read Git status and the diff since HEAD before writing a commit."),
       Tool("commit_and_push_changes",
            "Stage all repository changes, commit with a generated title and "
            "description, and push to the configured upstream.",
